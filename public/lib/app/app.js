...
function createContent(stockdetails) {
	...
	//console.log("6. Rendering the Summary Data : "+stockdetails.summary);   
		 ...
		 summaryContent =  "<b> <font color='brown'>Summary :</font></b>&nbsp;&nbsp;&nbsp;&nbsp; <b> Symbol : </b><font color='blue'>"+stockdetails.summary.symbol+"</font>&nbsp;&nbsp;&nbsp;&nbsp;<b> Max : <font color='blue'>"+stockdetails.summary.max+"</font>&nbsp;&nbsp;&nbsp;&nbsp;<b> Min : </b><font color='blue'>"+stockdetails.summary.min+
						   "</font>&nbsp;&nbsp;&nbsp;&nbsp;<b> Total Volume : </b><font color='blue'>"+stockdetails.summary.volume+"</font>";						   
...
function showDojoChart() {
   ...
   // var chartData1= [10,20,30,40,50];
	...
	if(!chart) {
		...
		chart.addAxis("y", { min: 5, max: 50, vertical: true, labelFunc : yAxisLabelFunc});
